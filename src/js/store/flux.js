const getState = ({ getStore, getActions, setStore }) => { // setStore updates the store
    return {
        ...
        actions: {
            createUser: () => {
                fetch("https://playground.4geeks.com/contact/agendas/javier", {
                    method: "POST",
            ...
            getInfoContacts: () => {
                fetch("https://playground.4geeks.com/contact/agendas/javier/contacts", {
                    method: "GET"
                })
                    .then((response) => {
            ...
            deleteContact: (id) => {
                fetch(`https://playground.4geeks.com/contact/agendas/javier/contacts/${id}`, {
                    method: "DELETE",
                })
                    .then((response) => {
